...
Page({
  ...
  report(shoulder, chest, waist, hip){ 
    ...
    if(a>0.05 || b>0.05) {
      ...
      if(c<0.05 && c>=0 && a<0.05 && a>=0 && (( f>=0 &&f<0.05 )||( b>=0 && b<0.05)) && e<0.25 && e>=0 && d<0.25&& d>=0 ) {
        style=2
      } else {
        if(g>0.05||f>0.05){ 
          style=3
        } else if( c<0.05&& c>=0 && e>0.25 && h>0.25&& d>0.25 ){
          style=4
        } else { style = 0 }
      }
    }
